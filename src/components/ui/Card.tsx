...
export function Card({
  ...
  return (
    <section
      className={`bg-white rounded-xl border border-slate-200/80 shadow-[0_1px_2px_rgba(15,23,42,0.04)] flex flex-col ${className}`}
    >
      {(title || action) && (
      ...
      {footer && <div className="px-6 py-3 border-t border-slate-100">{footer}</div>}
    </section>
  );
}
